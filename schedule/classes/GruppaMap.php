...
class GruppaMap extends BaseMap
{
    ...
    public function findAll($ofset=0, $limit=30){
        $res = $this->db->query("SELECT gruppa.gruppa_id,
            ...
            gruppa.date_end". " FROM gruppa INNER JOIN special ON
            gruppa.special_id=special.special_id LIMIT $ofset,$limit");
    ...
    public function findViewById($id=null){
        if ($id) {
            ...
            gruppa.special_id=special.special_id WHERE gruppa_id =$id");
